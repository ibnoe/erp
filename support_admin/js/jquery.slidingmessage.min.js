(function(){jQuery.showMessage=function(b,a){settings=jQuery.extend({id:"sliding_message_box",position:"bottom",size:"90",backgroundColor:"#9F0000",delay:3500,speed:500,fontSize:"30px"},a);a=$("#"+settings.id);if(a.length==0){a=$("<div></div>").attr("id",settings.id);a.css({"z-index":"999","background-color":settings.backgroundColor,"text-align":"center","color":"#FFFFFF",position:"absolute",position:"fixed",left:"0",width:"100%","line-height":settings.size+"px","font-size":settings.fontSize});$("body").append(a)}a.html(b);
