...
<div class="row">
    ...
    <div class="col-xs-6">    
		...
		<table class="table table-bordered">
			...
			<tr>
				<td>Date - Time</td>
				<td>: <?php echo date("d-m-Y", strtotime($sold_date)) ;?>  <?php echo $sold_time;?></td>
			</tr>
			<tr>
				<td>Sold By</td><td>: <?php echo $sold_by;?></td>
		   </tr>		
		</table>    
    </div>
    ...
    <div class="customer">Customer Name : <?php echo $customer_name;?> (<?php echo $customer_mobile;?>)</div>
	...
	<div id="invoice_footer">
				...
				<span style="margin-left: 10px;">Software Developed By Caneflex Limited www.caneflex.com</span>
	</div>
