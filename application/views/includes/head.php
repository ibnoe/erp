...
<link type="text/css" href="<?php echo base_url();?>assets/datepicker/jquery-ui-1.8.8.custom.css" rel="stylesheet" />
<script type="text/javascript" src="<?php echo base_url();?>assets/datepicker/jquery-ui-1.8.20.custom.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>assets/js/jquery.validate.js"></script>
      
<link rel="stylesheet" href="<?php echo base_url();?>assets/menu/cooker.drawer.css" type="text/css">
<link rel="stylesheet" href="<?php echo base_url();?>assets/menu/cooker.css" type="text/css">
