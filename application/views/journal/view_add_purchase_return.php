 ...
 <!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
 	 ...
 	 <div class="span-15">
 	  ...
 	  <form autocomplete="off" class="myform" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>journal/purchase_return_perform" method="post" name="myForm">
		
		<input type="hidden" name="credit" value="8"> <!-- 8= Purchase Return -->
		<label>Party</label> 
		
		<?php echo form_dropdown('debit', $party_acc_payble,'', 'id="debit"' ); ?> <br>
		<label>Amount</label>
...
<script type="text/javascript" src="<? echo base_url();?>support_admin/js/jquery.form.js"></script> <!-- This jquery.form.js is for Submitting form data using jquery and Ajax  -->
			...
			function showResponse(responseText, statusText, xhr, $form)  { 
		                    ...
		                    $.showMessage("Purchase Return Complete!", options); 
