...
<!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
  	...
  	<h2 >Select A Date Range Based on Receipt Date</h2>
 	 <hr>
   
    <div class="span-15">
  <form autocomplete="off" class="myform" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>journal/receipt_list" method="post" name="myForm">
