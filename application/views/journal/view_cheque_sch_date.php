...
<!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
  	...
  	<h2 >Select A Date Range Based On Cheque Date</h2>
 	 <hr>
   
    <div class="span-15">
  <form autocomplete="off" class="myform" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>journal/cheque_schedule" method="post" name="myForm">
		
		<label>Cheque Used For</label> 
		<?php	$options = array(
                  ''  => 'Select',
                  '1'    => 'Receipt',
                  '2'   => 'Payment',
               );
		 echo form_dropdown('cheque_type', $options,'', 'id="cheque_type"' ); ?> <br>
		<label>From</label>
...
$(document).ready(function() {
    ...
    var validator = $("#myForm").validate({
        ...
        messages: {
        	...
        	cheque_type:"Select Cheque Type",
