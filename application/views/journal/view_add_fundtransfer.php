 ...
 <!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
 	 ...
 	 <div class="span-15">
 	  ...
 	  <form autocomplete="off" class="myform" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>journal/journal_added" method="post" name="myForm">
		<label>Transfer To/Debit</label> 
		<?php echo form_dropdown('debit', $deibt,'', 'id="debit"' ); ?> <br>
		<label>Transfer From/Credit</label> 
		<?php echo form_dropdown('credit', $credit,'', 'id="credit"' ); ?> <br>
		<label>Amount</label>
...
<script type="text/javascript" src="<? echo base_url();?>support_admin/js/jquery.form.js"></script> <!-- This jquery.form.js is for Submitting form data using jquery and Ajax  -->
			...
			function showResponse(responseText, statusText, xhr, $form)  { 
		                    ...
		                    $.showMessage("Fund Transfer Complete!", options); 
