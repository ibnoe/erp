...
<!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
  	...
  	<h2 >Select A Date Range (Based On Entry Date)</h2>
 	 <hr>
   
    <div class="span-15">
  <form autocomplete="off" class="myform" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>rma/product_on_warranty_list" method="post" name="myForm">
