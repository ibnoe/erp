...
<!-- Navigation Start -->
 ...
 <!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
  	...
  	<h2 >Search Warranty Claim Invoice</h2>
  	
 	 <hr>
 	 <div class="span-15">
 	 
 	  <form autocomplete="off" class="myform2" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>rma/get_warranty_invoice" method="post" name="myForm">
		<label>Search By Warranty Invoice OR Serial</label>
