...
<div class="col-md-6" >
   ...
   <form role="form" id="myForm" name="myForm" class="form-horizontal" enctype="multipart/form-data" action="" method="post" autocomplete="off" >
      <div class="form-group">
         ...
         <div class="col-md-5">
            <input type="text" class="form-control" name="category_name" id="category_name" value="<?php echo $records[0]['category_name'];?>">
...
<script type="text/javascript"> 
   ...
   if(responseText==1){
   	...
   	window.setTimeout(function() {
   	    window.location.href = '<?php echo base_url();?>category/show';
   	}, 2000);
