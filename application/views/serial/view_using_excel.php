...
function showResponse(responseText, statusText, xhr, $form) {
    ...
    if (responseText == 2) {
        ...
        $("#response").html('Sorry ! Some of the provided serial numbers already exist in database').addClass('alert-danger').removeClass("hide").hide().fadeIn("slow");
         setTimeout(function() {
             $('#response').addClass('hide').fadeIn("slow");
         }, 5000); 
    }
    ...
    if (responseText == 5) {
        $("#loading").hide();
        $("#response").removeClass("alert-success") ;
        $("#response").html('You did not select your excel document').addClass('alert-danger').removeClass("hide").hide().fadeIn("slow");
         setTimeout(function() {
             $('#response').addClass('hide').fadeIn("slow");
         }, 5000); 
    }
