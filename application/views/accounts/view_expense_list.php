...
<script  type="text/javascript">
   $(function(){ // added
	   $('a.delete').live('click', function(event) {
     	 ...
     	 type: "POST",
     	 url: "<?php echo base_url(); ?>accounts/delete_expense",
     	 data: "id="+a_href,
				...
				<tbody>
				 <?php $i = $this->uri->segment(3) + 0; foreach ($records as $row){ $i++; ?>
				  		...
				  		<tr id="trid_<?php echo $row['id']; ?>">
				            ...
				            <?php if($level==1){?>	
							<td><a href="<?php echo base_url();?>accounts/edit_expense/<?php echo $row['id'];?>"><img src="<?php echo base_url();?>support_admin/images/icons/edit.png"></a></td>
				 			<td><a href="<?php echo $row['id'];?>" title="Delete" class="delete"><img src="<?php echo base_url();?>support_admin/images/icons/cross.png"></a></td>			            			  			
				       		  <?php }?>           		             
