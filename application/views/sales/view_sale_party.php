...
<!-- Colmun 1 -->
<div class="col-md-3">
   <form role="form" id="myForm" name="myForm" class="" enctype="multipart/form-data" action="<?php echo base_url();?>sales/add_to_cart_party" method="post" autocomplete="off" >
...
<!-- Colmun 2 -->
<div class="col-md-9">
   <form class="form-inline" role="form" autocomplete="off" class="" id="voucherform" name="voucherform" action="<?php echo base_url();?>sales/confirm_party_sales" method="post">
      <div class="form-group">
         <input type="text" size="10"  class="form-control" id="datepicker1"  name="sold_date" value="" />
      </div>
      <div class="form-group">			  
         <input type="text" size = "35" name="party_name" id="party_name" data-provide="typeahead"  value="" class="form-control" placeholder="Party Name"/>
         <input type="hidden" name="party_id" id="party_id">
      </div>
     <span class="errorvoucher"></span>
...
$(document).ready(function() {
    ...
    var validator = $("#voucherform").validate({
        showErrors: function(errorMap, errorList) {
            $(".errorvoucher").html($.map(errorList, function (el) {
                return el.message;
            }).join(", "));
        },
        wrapper: "span",
...
<script  type="text/javascript">
 ...
 <script  type="text/javascript">
  ...
  //Do stuff
     	 ...
     	 type: "POST",
     	 url: "<?php echo base_url(); ?>commpn/get_products_custom",
