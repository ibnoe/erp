...
<table class="table table-striped" align="center" style="table-layout:fixed; overflow-x:hidden">
   ...
   <tfoot>
      <tr>
         ...
         <td><input class="form-control" readonly="readonly" name="total_amount" id="total_amount" value="<?php echo number_format($total,2) ;?>" style="border: 0px; background:transparent;"></td>
         <td>&nbsp;</td>
      </tr>
      <tr>
         <td>&nbsp;</td>
         <td>&nbsp;</td>
         <td colspan="2" style="text-align:center;">Paid Amount</td>
         <td><input class="form-control" type="text" class="amount_paid numeric" name="amount_paid" id="amount_paid"></td>
         <td>&nbsp;</td>
      </tr>
      <tr>
         <td>&nbsp;</td>
         ...
         <td><input class="form-control" readonly="readonly" class="balance" name="balance" id="balance" value="<?php echo number_format($total,2)?>"></td>
         <td>&nbsp;</td>
      </tr>
   </tfoot>
</table>
   ...
   $(function(){
   	...
   	$('#amount_paid').bind('keyup', function() {
   		   if($.trim(this.value).length) {
   		     var balance = accounting.unformat($('#total_amount').val().replace(/,/g, ''))-accounting.unformat(this.value);
...
<script type="text/javascript">
   $(":text[name='rate[]']").bind("keyup", function() {
      ...
      var amount_paid= parseFloat($("#amount_paid").val().replace(/,/g, '') || 0);
      	...
      	var balance= totalamount-amount_paid;
      		$("#balance").val("");
           $("#balance").val(balance).formatCurrency();;
   ...
   $(function(){ // added
    ...
    $('a.delete').click(function(){
   	var a_href = $(this).attr('href'); 
      	 ...
      	 type: "POST",
      	 url: "<?php echo base_url(); ?>sales/delete_cart_item_party",
      	 data: "id="+a_href,
