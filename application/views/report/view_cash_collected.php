...
<!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
  	...
  	<h2>Total Cash Collection Including Cheques</h2>
 	 <hr>
   
    <div class="span-15">
  <form autocomplete="off" class="myform" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>report/cash_collection_fetch" method="post" name="myForm">
		<label>Software User</label> 
		<?php echo form_dropdown('user_id', $software_users,'', 'id="user_id"' ); ?> <br>		
