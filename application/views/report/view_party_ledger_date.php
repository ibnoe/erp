...
<!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
  	...
  	<h2>Party Ledger: Select A Date Range</h2>
 	 <hr>
   
    <div class="span-15">
  <form autocomplete="off" class="myform" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>report/ledger" method="post" name="myForm">
