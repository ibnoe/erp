...
<!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
  	...
  	<h2>Print Party Ledger: Select A Date Range</h2>
 	 <hr>
   
    <div class="span-15">
  <form autocomplete="off" class="myform" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>pdf/print_ledger" method="post" name="myForm">
		
		<label>Party Account</label> 
		<?php echo form_dropdown('account_id', $party_acc,'', 'id="account_id"' ); ?> <br>
		<label>From</label>
