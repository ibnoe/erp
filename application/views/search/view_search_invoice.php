 ...
 <!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
 	 ...
 	 <div class="span-15">
 	  ...
 	  <form autocomplete="off" class="myform2" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>search/search_invoice_result" method="post" name="myForm">
...
$(document).ready(function() {
    ...
    var validator = $("#myForm").validate({
        ...
        messages: {
        	...
        	search_by: "Select The Search Type",
