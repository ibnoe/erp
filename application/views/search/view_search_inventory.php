...
<!-- Navigation Start -->
 ...
 <!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
  	...
  	<h2 >Search Product In Inventory</h2>
  	
 	 <hr>
 	 <div class="span-15">
 	 
 	  <form autocomplete="off" class="myform" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>search/search_inventory_result" method="post" name="myForm">
...
$(document).ready(function() {
    ...
    var validator = $("#myForm").validate({
        ...
        messages: {
        	...
        	product_serial: "Enter A Product Serial",
