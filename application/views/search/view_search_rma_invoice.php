...
<!-- Navigation Start -->
 ...
 <!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
  	...
  	<h2>Search Replacement Delivery Invoice</h2>
  	
 	 <hr>
 	 <div class="span-15">
 	 
 	  <form autocomplete="off" class="myform2" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>search/search_rma_invoice_result" method="post" name="myForm">
		<label>Replacement Delivery Invoice#</label>
				
		<input type="text" name=invoice_number size="40"/>
...
$(document).ready(function() {
    ...
    var validator = $("#myForm").validate({
        ...
        messages: {
        	...
        	invoice_number: "Enter Replacement Delivery Invoice Number",
