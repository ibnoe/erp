...
<!-- Navigation Start -->
 ...
 <!-- Main Area/Content Starts -->
    <div id="content" class="span-24"> 
  	...
  	<h2>Search Purchase Voucher</h2>
  	
 	 <hr>
 	 <div class="span-15">
 	 
 	  <form autocomplete="off" class="myform2" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>search/search_purchase_voucher_result" method="post" name="myForm">
...
$(document).ready(function() {
    ...
    var validator = $("#myForm").validate({
        ...
        messages: {
        	...
        	search_by: "Select Search Type",
        	serial: "Enter Search Information",
